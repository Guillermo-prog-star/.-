...
export const PLANES_MOCK: PlanTransformacion[] = [
  {
    ...
    misiones: [
      ...
      {
        id: 'mis-emociones-4',
        titulo: 'Pausa Consciente Familiar (Iniciativa)',
        estado: 'Pendiente',
        descripcionGeneral: 'Micro-acciones creativas propuestas por la familia para desconectar del caos y reconectar con la tranquilidad.',
        queBusca: 'Estimular la autonomía y proactividad familiar para modular el clima emocional diario de forma lúdica.',
        esIniciativaFamiliar: true,
        pasoAPaso: [
          'Definir un gatillo visual o alarma para decretar un receso emocional voluntario.',
          'Realizar juntos una micro-acción de 5 minutos (escuchar una canción alegre, estiramiento, silencio).',
          'Anotar en la bitácora familiar el nivel de armonía antes y después del receso.'
        ],
        microacciones: [
          { id: 'ma-e4-1', icono: 'palette', descripcion: 'Definir colectivamente y escribir la micro-acción creativa de calma elegida.' },
          { id: 'ma-e4-2', icono: 'timer', descripcion: 'Detener actividades y ejecutar la pausa consciente familiar por 5 minutos.' },
          { id: 'ma-e4-3', icono: 'rate_review', descripcion: 'Registrar la victoria de autorregulación en la bitácora con los emojis correspondientes.' }
        ]
      },
      {
        id: 'mis-emociones-5',
  ...
  },
  {
    ...
    misiones: [
      ...
      {
        id: 'mis-comunicacion-4',
        titulo: 'Acuerdos Escritos de Convivencia (Iniciativa)',
        estado: 'Pendiente',
        descripcionGeneral: 'Diseñar de forma participativa un decálogo o acta de acuerdos comunicativos para resolver roces diarios.',
        queBusca: 'Fomentar la corresponsabilidad y estructurar reglas explícitas de diálogo asertivo consensuadas por todos.',
        esIniciativaFamiliar: true,
        pasoAPaso: [
          'Reunirse en sesión de co-creación familiar para identificar las 3 fricciones lingüísticas más comunes.',
          'Redactar 3 reglas claras en positivo (ej: "Hablamos pausado cuando hay desacuerdos").',
          'Firmar la cartilla de acuerdos y fijarla en el tablero familiar.'
        ],
        microacciones: [
          { id: 'ma-c4-1', icono: 'palette', descripcion: 'Co-crear y redactar los 3 compromisos escritos de diálogo positivo.' },
          { id: 'ma-c4-2', icono: 'rate_review', descripcion: 'Estampar las firmas de todos los integrantes en el cartel físico final.' },
          { id: 'ma-c4-3', icono: 'photo_camera', descripcion: 'Subir foto de los acuerdos firmados al portal para el análisis de adherencia.' }
        ]
      },
      {
        id: 'mis-comunicacion-5',
  ...
  },
  {
    ...
    misiones: [
      ...
      {
        id: 'mis-habitos-4',
        titulo: 'Tablero de Hábitos Saludables (Iniciativa)',
        estado: 'Pendiente',
        descripcionGeneral: 'Diseño creativo de un rastreador visual en cartulina para registrar metas de bienestar cotidianas.',
        queBusca: 'Estimular la constancia relacional y celebrar pequeños avances físicos y mentales en equipo.',
        esIniciativaFamiliar: true,
        pasoAPaso: [
          'Dibujar un tablero mensual con columnas para hábitos saludables (hidratación, ejercicio, orden).',
          'Cada miembro dibuja un emoji o pega un sticker al cumplir su meta individual diaria.',
          'Establecer una recompensa lúdica familiar por cumplir el 80% de la meta grupal.'
        ],
        microacciones: [
          { id: 'ma-h4-1', icono: 'palette', descripcion: 'Diseñar y colorear el rastreador visual de hábitos familiares.' },
          { id: 'ma-h4-2', icono: 'rate_review', descripcion: 'Registrar las marcas diarias de bienestar de todos los integrantes.' },
          { id: 'ma-h4-3', icono: 'photo_camera', descripcion: 'Capturar y subir evidencia del progreso visual consolidado.' }
        ]
      },
      {
        id: 'mis-habitos-5',
  ...
  },
  {
    ...
    misiones: [
      ...
      {
        id: 'mis-tiempos-4',
        titulo: 'Cita Individual Padre-Hijo (Iniciativa)',
        estado: 'Pendiente',
        descripcionGeneral: 'Agendar un espacio de 20 minutos individuales entre un cuidador y un hijo para conversar o jugar libremente.',
        queBusca: 'Nutrir el vínculo particular de forma asertiva, atendiendo necesidades emocionales específicas de manera directa.',
        esIniciativaFamiliar: true,
        pasoAPaso: [
          'Elegir al azar el par cuidador-hijo de la semana.',
          'Reservar 20 minutos de juego libre o charla dirigida en un café o habitación sin celulares.',
          'Interesarse genuinamente por sus sueños y emociones, validando sin dar lecciones.'
        ],
        microacciones: [
          { id: 'ma-t4-1', icono: 'calendar_today', descripcion: 'Agendar en el calendario familiar la micro-cita exclusiva padre-hijo.' },
          { id: 'ma-t4-2', icono: 'forum', descripcion: 'Disfrutar y dialogar en intimidad libre de distracciones tecnológicas.' },
          { id: 'ma-t4-3', icono: 'rate_review', descripcion: 'Registrar en la bitácora los aprendizajes o alegrías obtenidas en el espacio.' }
        ]
      },
      {
        id: 'mis-tiempos-5',
